...
# PACS
#data_dir=
#python -u train_adv_depthnet_two_class_epoch=10_div_real_adv.py
python -u train_adv_depthnet_two_class_epoch=10_div_real_adv.py --attack PGD-AT --model Depthnet_PGD-AT_eps6_casia --log Depthnet__two_class_PGD-AT_eps6_casia
