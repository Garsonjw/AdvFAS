...
# PACS
#data_dir=
python -u train_adv_depthnet_two_class_epoch=10_div_real_adv.py --attack DI-FGSM-AT --model Depthnet_DI-FGSM-AT_casia --log Depthnet__two_class_DI-FGSM-AT_casia
# TerraIncognita
#data_dir=
