...
def train_test():
    ...
    for epoch in range(args.epochs):  # loop over the dataset multiple times
        ...
        for images, lables in dataloader_train:
            ...
            # absolute_loss = (absolute_loss.mean(dim = (1,2))*mask).mean()*2
            ...
            #spoof_loss = (spoof_loss*mask).mean()
            adv_loss = nn.BCELoss()(adv_out.squeeze(-1).float(), lables_adv.float())

            spoof_loss = 3*spoof_loss + absolute_loss+ absolute_loss_adv + adv_loss*3
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log', type=str, default="depthnet_adv-double", help='log and save model name')
