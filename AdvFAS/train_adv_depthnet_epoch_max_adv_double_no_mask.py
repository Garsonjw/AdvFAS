    ...
    for epoch in range(args.epochs):  # loop over the dataset multiple times
        ...
        if epoch % epoch_test == epoch_test-1:    # test every 5 epochs  
            ...
            for images, lables in dataloader_val:
                ...
                if lables[0] ==0:
                    if adv_score[1].item() <=0.5:
                    ###保存分数和adv分数、原始标签
                        map_score_list.append('{} {}\n'.format(spoof_out[1].item(), lables[1].item()))
                    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log', type=str, default="depthnet_adv-double_no_mask", help='log and save model name')
