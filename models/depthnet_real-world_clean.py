...
if __name__ == '__main__':
    ...
    a=torch.load('../checkpoint/train_no_adv_depthnet_testadv_last_PGD.pt')
    # new_state_dict = {}
    # for k,v in a.items():
    ...
    with torch.no_grad():
        model.eval()
        test_data = MyDataset('/data/home/scv7305/run/chenjiawei/fasdata/crop_realface/facepath.txt', transform=transforms.Compose([transforms.ToTensor(), transforms.Normalize(mean                                =[0.485, 0.456, 0.406], std = [0.229, 0.224, 0.225])]))
